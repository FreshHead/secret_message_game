...
export default class Deck {
    ...
    cardDict = new Map([['Gurdian', Gurdian], ['Monk', Monk], ['Baron', Baron], ['Maid', Maid], ['Prince', Prince], ['King', King], ['Countess', Countess], ['Princess', Princess]]);
    cards = new Array(16)
    ...
    constructor() {
        ...
        for (let cardType in this.cardQuantity) {
            this.cards = this.cards.fill(new (this.cardDict.get(cardType)), fillIdx, fillIdx += this.cardQuantity[cardType])
        }
        // Shuffle cards
